    ...
    const handleBookingSubmit = async (e: React.FormEvent) => {
        ...
        try {
            await createReservation(
                selectedFlight.id,
                selectedFlight.prices?.[0]?.id || 0,  // flightPriceId
                undefined  // Otomatik koltuk atama
            );
                        ...
                        <div className="flight-summary">
                            ...
                            <p className="price">
                                {selectedFlight.prices.length > 0 ?
                                    `${selectedFlight.prices[0].price} ${getCurrencySymbol(selectedFlight.prices[0].currency)}` :
                                    'Fiyat Yok'
                                }
                            </p>
                        </div>
